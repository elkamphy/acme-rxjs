...
import { catchError, Observable, tap, map,throwError, combineLatest, BehaviorSubject, Subject, merge, scan, shareReplay, switchMap, forkJoin, filter, of } from 'rxjs';
...
export class ProductService {
  ...
  selectedProduct$ = combineLatest([this.productsWithCategory$,this.productSelectedAction$])
      ...
      .pipe(
        ...
        tap(suppliers =>
          console.log('products suppliers : ', suppliers)
          ),
          shareReplay(1)
      );
